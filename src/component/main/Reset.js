...
export const Reset = () => {
    ...
    const {reset} = useSelector(state => state.language.arr)
    const [email, setEmail] = React.useState('')
    const [pass, setPass] = React.useState('')
    const {button = {}, tab = [], title = "", description = "",register="", attention={}} = reset;
        ...
        <Container component="main" maxWidth="xs">
            ...
            >
                ...
                <Box component="form" onSubmit={handleSubmit} noValidate
                    ...
                    <InputElement label={tab[0]?.input_label} placeholder={tab[0]?.input_label} name="pass"/>
                    <InputElement label={tab[1]?.input_label} placeholder={tab[1]?.input_label} name="re_pass"/>
